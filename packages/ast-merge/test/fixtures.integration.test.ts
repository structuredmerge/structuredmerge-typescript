...
import type {
  ...
  StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport,
...
import {
  ...
  importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope,
  ...
  importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope,
...
interface StructuredEditRequestFixture {
  cases: Array<{
    ...
    request: {
      ...
      target_match?: {
        start_boundary: string;
        start_boundary_family?: string | null;
        known_start_boundary: boolean;
        end_boundary: string;
        end_boundary_family?: string | null;
        known_end_boundary: boolean;
        payload_kind: string;
...
interface StructuredEditParityMatchSemanticsFixture {
  cases: Array<{
    label: string;
    request: StructuredEditRequestFixture['cases'][number]['request'];
  }>;
...
interface StructuredEditProviderExecutionInvocationEnvelopeFixture {
  structured_edit_provider_execution_invocation: StructuredEditProviderExecutionInvocationFixture['cases'][number]['execution_invocation'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionInvocationEnvelope['kind'];
    version: number;
    execution_invocation: StructuredEditProviderExecutionInvocationFixture['cases'][number]['execution_invocation'];
  };
}

interface StructuredEditProviderExecutionInvocationEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionInvocationEnvelopeApplicationFixture {
  structured_edit_provider_execution_invocation_envelope: StructuredEditProviderExecutionInvocationEnvelopeFixture['expected_envelope'];
  expected_execution_invocation: StructuredEditProviderExecutionInvocationFixture['cases'][number]['execution_invocation'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderExecutionInvocationEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderBatchExecutionInvocationFixture {
  cases: Array<{
    label: string;
    batch_execution_invocation: {
      invocations: StructuredEditProviderExecutionInvocationFixture['cases'][number]['execution_invocation'][];
      metadata?: Record<string, unknown>;
    };
  }>;
}

interface StructuredEditProviderBatchExecutionInvocationEnvelopeFixture {
  structured_edit_provider_batch_execution_invocation: StructuredEditProviderBatchExecutionInvocationFixture['cases'][number]['batch_execution_invocation'];
  expected_envelope: {
    kind: StructuredEditProviderBatchExecutionInvocationEnvelope['kind'];
    version: number;
    batch_execution_invocation: StructuredEditProviderBatchExecutionInvocationFixture['cases'][number]['batch_execution_invocation'];
  };
}

interface StructuredEditProviderBatchExecutionInvocationEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderBatchExecutionInvocationEnvelopeApplicationFixture {
  structured_edit_provider_batch_execution_invocation_envelope: StructuredEditProviderBatchExecutionInvocationEnvelopeFixture['expected_envelope'];
  expected_batch_execution_invocation: StructuredEditProviderBatchExecutionInvocationFixture['cases'][number]['batch_execution_invocation'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderBatchExecutionInvocationEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderExecutionRunResultFixture {
  cases: Array<{
    label: string;
...
interface StructuredEditProviderExecutionRunResultEnvelopeFixture {
  structured_edit_provider_execution_run_result: StructuredEditProviderExecutionRunResultFixture['cases'][number]['execution_run_result'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionRunResultEnvelope['kind'];
    version: number;
    execution_run_result: StructuredEditProviderExecutionRunResultFixture['cases'][number]['execution_run_result'];
  };
}

interface StructuredEditProviderExecutionRunResultEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionRunResultEnvelopeApplicationFixture {
  structured_edit_provider_execution_run_result_envelope: StructuredEditProviderExecutionRunResultEnvelopeFixture['expected_envelope'];
  expected_execution_run_result: StructuredEditProviderExecutionRunResultFixture['cases'][number]['execution_run_result'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderExecutionRunResultEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderBatchExecutionRunResultFixture {
  cases: Array<{
    label: string;
    batch_execution_run_result: {
      run_results: StructuredEditProviderExecutionRunResultFixture['cases'][number]['execution_run_result'][];
      metadata?: Record<string, unknown>;
    };
  }>;
}

interface StructuredEditProviderBatchExecutionRunResultEnvelopeFixture {
  structured_edit_provider_batch_execution_run_result: StructuredEditProviderBatchExecutionRunResultFixture['cases'][number]['batch_execution_run_result'];
  expected_envelope: {
    kind: StructuredEditProviderBatchExecutionRunResultEnvelope['kind'];
    version: number;
    batch_execution_run_result: StructuredEditProviderBatchExecutionRunResultFixture['cases'][number]['batch_execution_run_result'];
  };
}

interface StructuredEditProviderBatchExecutionRunResultEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderBatchExecutionRunResultEnvelopeApplicationFixture {
  structured_edit_provider_batch_execution_run_result_envelope: StructuredEditProviderBatchExecutionRunResultEnvelopeFixture['expected_envelope'];
  expected_batch_execution_run_result: StructuredEditProviderBatchExecutionRunResultFixture['cases'][number]['batch_execution_run_result'];
  cases: Array<{
    label: string;
...
interface StructuredEditProviderExecutionReceiptEnvelopeFixture {
  structured_edit_provider_execution_receipt: StructuredEditProviderExecutionReceiptFixture['cases'][number]['execution_receipt'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionReceiptEnvelope['kind'];
    version: number;
    execution_receipt: StructuredEditProviderExecutionReceiptFixture['cases'][number]['execution_receipt'];
  };
}

interface StructuredEditProviderExecutionReceiptEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionReceiptEnvelopeApplicationFixture {
  structured_edit_provider_execution_receipt_envelope: StructuredEditProviderExecutionReceiptEnvelopeFixture['expected_envelope'];
  expected_execution_receipt: StructuredEditProviderExecutionReceiptFixture['cases'][number]['execution_receipt'];
  cases: Array<{
    label: string;
...
interface StructuredEditProviderExecutionReceiptReplayRequestEnvelopeFixture {
  structured_edit_provider_execution_receipt_replay_request: StructuredEditProviderExecutionReceiptReplayRequestFixture['cases'][number]['receipt_replay_request'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionReceiptReplayRequestEnvelope['kind'];
    version: number;
    receipt_replay_request: StructuredEditProviderExecutionReceiptReplayRequestFixture['cases'][number]['receipt_replay_request'];
  };
}

interface StructuredEditProviderExecutionReceiptReplayRequestEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionReceiptReplayRequestEnvelopeApplicationFixture {
  structured_edit_provider_execution_receipt_replay_request_envelope: StructuredEditProviderExecutionReceiptReplayRequestEnvelopeFixture['expected_envelope'];
  expected_receipt_replay_request: StructuredEditProviderExecutionReceiptReplayRequestFixture['cases'][number]['receipt_replay_request'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderExecutionReceiptReplayRequestEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplayRequestFixture {
  cases: Array<{
    label: string;
    batch_receipt_replay_request: {
      requests: StructuredEditProviderExecutionReceiptReplayRequestFixture['cases'][number]['receipt_replay_request'][];
      metadata?: Record<string, unknown>;
    };
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeFixture {
  structured_edit_provider_batch_execution_receipt_replay_request: StructuredEditProviderBatchExecutionReceiptReplayRequestFixture['cases'][number]['batch_receipt_replay_request'];
  expected_envelope: {
    kind: StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope['kind'];
    version: number;
    batch_receipt_replay_request: StructuredEditProviderBatchExecutionReceiptReplayRequestFixture['cases'][number]['batch_receipt_replay_request'];
  };
}

interface StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeApplicationFixture {
  structured_edit_provider_batch_execution_receipt_replay_request_envelope: StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeFixture['expected_envelope'];
  expected_batch_receipt_replay_request: StructuredEditProviderBatchExecutionReceiptReplayRequestFixture['cases'][number]['batch_receipt_replay_request'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderExecutionReceiptReplayApplicationFixture {
  cases: Array<{
    label: string;
...
interface StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeFixture {
  structured_edit_provider_execution_receipt_replay_application: StructuredEditProviderExecutionReceiptReplayApplicationFixture['cases'][number]['receipt_replay_application'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionReceiptReplayApplicationEnvelope['kind'];
    version: number;
    receipt_replay_application: StructuredEditProviderExecutionReceiptReplayApplicationFixture['cases'][number]['receipt_replay_application'];
  };
}

interface StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeApplicationFixture {
  structured_edit_provider_execution_receipt_replay_application_envelope: StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeFixture['expected_envelope'];
  expected_receipt_replay_application: StructuredEditProviderExecutionReceiptReplayApplicationFixture['cases'][number]['receipt_replay_application'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture {
  cases: Array<{
    label: string;
    batch_receipt_replay_application: {
      applications: StructuredEditProviderExecutionReceiptReplayApplicationFixture['cases'][number]['receipt_replay_application'][];
      metadata?: Record<string, unknown>;
    };
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeFixture {
  structured_edit_provider_batch_execution_receipt_replay_application: StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture['cases'][number]['batch_receipt_replay_application'];
  expected_envelope: {
    kind: StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope['kind'];
    version: number;
    batch_receipt_replay_application: StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture['cases'][number]['batch_receipt_replay_application'];
  };
}

interface StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeApplicationFixture {
  structured_edit_provider_batch_execution_receipt_replay_application_envelope: StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeFixture['expected_envelope'];
  expected_batch_receipt_replay_application: StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture['cases'][number]['batch_receipt_replay_application'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderExecutionReceiptReplaySessionFixture {
  cases: Array<{
    label: string;
...
interface StructuredEditProviderExecutionReceiptReplaySessionEnvelopeFixture {
  structured_edit_provider_execution_receipt_replay_session: StructuredEditProviderExecutionReceiptReplaySessionFixture['cases'][number]['receipt_replay_session'];
  expected_envelope: {
    kind: StructuredEditProviderExecutionReceiptReplaySessionEnvelope['kind'];
    version: number;
    receipt_replay_session: StructuredEditProviderExecutionReceiptReplaySessionFixture['cases'][number]['receipt_replay_session'];
  };
}

interface StructuredEditProviderExecutionReceiptReplaySessionEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderExecutionReceiptReplaySessionEnvelopeApplicationFixture {
  structured_edit_provider_execution_receipt_replay_session_envelope: StructuredEditProviderExecutionReceiptReplaySessionEnvelopeFixture['expected_envelope'];
  expected_receipt_replay_session: StructuredEditProviderExecutionReceiptReplaySessionFixture['cases'][number]['receipt_replay_session'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderExecutionReceiptReplaySessionEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplaySessionFixture {
  cases: Array<{
    label: string;
    batch_receipt_replay_session: {
      sessions: StructuredEditProviderExecutionReceiptReplaySessionFixture['cases'][number]['receipt_replay_session'][];
      metadata?: Record<string, unknown>;
    };
  }>;
}

interface StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeFixture {
  structured_edit_provider_batch_execution_receipt_replay_session: StructuredEditProviderBatchExecutionReceiptReplaySessionFixture['cases'][number]['batch_receipt_replay_session'];
  expected_envelope: {
    kind: StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope['kind'];
    version: number;
    batch_receipt_replay_session: StructuredEditProviderBatchExecutionReceiptReplaySessionFixture['cases'][number]['batch_receipt_replay_session'];
  };
}

interface StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeRejectionFixture {
  cases: Array<{
    label: string;
    envelope: {
      kind: string;
...
interface StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeApplicationFixture {
  structured_edit_provider_batch_execution_receipt_replay_session_envelope: StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeFixture['expected_envelope'];
  expected_batch_receipt_replay_session: StructuredEditProviderBatchExecutionReceiptReplaySessionFixture['cases'][number]['batch_receipt_replay_session'];
  cases: Array<{
    label: string;
    envelope: StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeRejectionFixture['cases'][number]['envelope'];
    expected_error: StructuredEditTransportImportError;
  }>;
}
...
function normalizeStructuredEditTargetMatch(
  raw: NonNullable<StructuredEditRequestFixture['cases'][number]['request']['target_match']>
): StructuredEditTargetMatch {
  return {
    startBoundary: raw.start_boundary,
    startBoundaryFamily: raw.start_boundary_family ?? undefined,
    knownStartBoundary: raw.known_start_boundary,
    endBoundary: raw.end_boundary,
    endBoundaryFamily: raw.end_boundary_family ?? undefined,
    knownEndBoundary: raw.known_end_boundary,
    payloadKind: raw.payload_kind,
    payloadFamily: raw.payload_family ?? undefined,
    knownPayloadKind: raw.known_payload_kind,
    commentAnchored: raw.comment_anchored,
    trailingGapExtended: raw.trailing_gap_extended,
    metadata: raw.metadata
...
function normalizeStructuredEditProviderExecutionInvocationEnvelope(
  raw: StructuredEditProviderExecutionInvocationEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionInvocationEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    executionInvocation: normalizeStructuredEditProviderExecutionInvocation(
      raw.execution_invocation
    )
  };
}

function normalizeStructuredEditProviderBatchExecutionInvocation(
  raw: StructuredEditProviderBatchExecutionInvocationFixture['cases'][number]['batch_execution_invocation']
): StructuredEditProviderBatchExecutionInvocation {
  return {
    invocations: raw.invocations.map((invocation) =>
      normalizeStructuredEditProviderExecutionInvocation(invocation)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionInvocationEnvelope(
  raw: StructuredEditProviderBatchExecutionInvocationEnvelopeFixture['expected_envelope']
): StructuredEditProviderBatchExecutionInvocationEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    batchExecutionInvocation: normalizeStructuredEditProviderBatchExecutionInvocation(
      raw.batch_execution_invocation
    )
  };
}

function normalizeStructuredEditProviderExecutionRunResult(
  raw: StructuredEditProviderExecutionRunResultFixture['cases'][number]['execution_run_result']
): StructuredEditProviderExecutionRunResult {
  return {
    executionInvocation: normalizeStructuredEditProviderExecutionInvocation(
      raw.execution_invocation
...
function normalizeStructuredEditProviderExecutionRunResultEnvelope(
  raw: StructuredEditProviderExecutionRunResultEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionRunResultEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    executionRunResult: normalizeStructuredEditProviderExecutionRunResult(raw.execution_run_result)
  };
}

function normalizeStructuredEditProviderBatchExecutionRunResult(
  raw: StructuredEditProviderBatchExecutionRunResultFixture['cases'][number]['batch_execution_run_result']
): StructuredEditProviderBatchExecutionRunResult {
  return {
    runResults: raw.run_results.map((runResult) =>
      normalizeStructuredEditProviderExecutionRunResult(runResult)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionRunResultEnvelope(
  raw: StructuredEditProviderBatchExecutionRunResultEnvelopeFixture['expected_envelope']
): StructuredEditProviderBatchExecutionRunResultEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
...
function normalizeStructuredEditProviderExecutionReceiptEnvelope(
  raw: StructuredEditProviderExecutionReceiptEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionReceiptEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
...
function normalizeStructuredEditProviderExecutionReceiptReplayRequestEnvelope(
  raw: StructuredEditProviderExecutionReceiptReplayRequestEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionReceiptReplayRequestEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    receiptReplayRequest: normalizeStructuredEditProviderExecutionReceiptReplayRequest(
      raw.receipt_replay_request
    )
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayRequest(
  raw: StructuredEditProviderBatchExecutionReceiptReplayRequestFixture['cases'][number]['batch_receipt_replay_request']
): StructuredEditProviderBatchExecutionReceiptReplayRequest {
  return {
    requests: raw.requests.map((request) =>
      normalizeStructuredEditProviderExecutionReceiptReplayRequest(request)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(
  raw: StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeFixture['expected_envelope']
): StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    batchReceiptReplayRequest: normalizeStructuredEditProviderBatchExecutionReceiptReplayRequest(
      raw.batch_receipt_replay_request
    )
  };
}

function normalizeStructuredEditProviderExecutionReceiptReplayApplication(
  raw: StructuredEditProviderExecutionReceiptReplayApplicationFixture['cases'][number]['receipt_replay_application']
): StructuredEditProviderExecutionReceiptReplayApplication {
  return {
    receiptReplayRequest: normalizeStructuredEditProviderExecutionReceiptReplayRequest(
      raw.receipt_replay_request
...
function normalizeStructuredEditProviderExecutionReceiptReplayApplicationEnvelope(
  raw: StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionReceiptReplayApplicationEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayApplication(
  raw: StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture['cases'][number]['batch_receipt_replay_application']
): StructuredEditProviderBatchExecutionReceiptReplayApplication {
  return {
    applications: raw.applications.map((application) =>
      normalizeStructuredEditProviderExecutionReceiptReplayApplication(application)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope(
  raw: StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeFixture['expected_envelope']
): StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    batchReceiptReplayApplication:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayApplication(
        raw.batch_receipt_replay_application
      )
  };
}

function normalizeStructuredEditProviderExecutionReceiptReplaySession(
  raw: StructuredEditProviderExecutionReceiptReplaySessionFixture['cases'][number]['receipt_replay_session']
): StructuredEditProviderExecutionReceiptReplaySession {
  return {
    receiptReplayApplication: normalizeStructuredEditProviderExecutionReceiptReplayApplication(
      raw.receipt_replay_application
...
function normalizeStructuredEditProviderExecutionReceiptReplaySessionEnvelope(
  raw: StructuredEditProviderExecutionReceiptReplaySessionEnvelopeFixture['expected_envelope']
): StructuredEditProviderExecutionReceiptReplaySessionEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplaySession(
  raw: StructuredEditProviderBatchExecutionReceiptReplaySessionFixture['cases'][number]['batch_receipt_replay_session']
): StructuredEditProviderBatchExecutionReceiptReplaySession {
  return {
    sessions: raw.sessions.map((session) =>
      normalizeStructuredEditProviderExecutionReceiptReplaySession(session)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(
  raw: StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeFixture['expected_envelope']
): StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope {
  return {
    kind: raw.kind,
    version: STRUCTURED_EDIT_TRANSPORT_VERSION,
    batchReceiptReplaySession: normalizeStructuredEditProviderBatchExecutionReceiptReplaySession(
      raw.batch_receipt_replay_session
    )
  };
}

function normalizeStructuredEditProviderExecutionReceiptReplayWorkflow(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflow {
  return {
    receiptReplaySession: normalizeStructuredEditProviderExecutionReceiptReplaySession(
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflow(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflow {
  return {
    workflows: raw.workflows.map((workflow: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflow(workflow)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest {
  return {
    receiptReplayWorkflowResult:
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyResult {
  return {
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement {
  return {
    receiptReplayWorkflowApplyDecisionOutcome:
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome(
        raw.receiptReplayWorkflowApplyDecisionOutcome ??
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport {
  return {
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope {
  return {
    kind: raw.kind,
    ...
    receiptReplayWorkflowApplyResult:
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(
        raw.receipt_replay_workflow_apply_result
      )
  };
}
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest {
  return {
    applyRequests: raw.apply_requests.map((request: any) =>
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult {
  return {
    applyResults: raw.apply_results.map((result: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(result)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision {
  return {
    applyDecisions: (raw.applyDecisions ?? raw.apply_decisions ?? []).map((entry: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecision(entry)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome {
  return {
    applyDecisionOutcomes: (raw.applyDecisionOutcomes ?? raw.apply_decision_outcomes ?? []).map(
      (entry: any) =>
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome(entry)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement {
  return {
    applyDecisionSettlements: (
      raw.applyDecisionSettlements ??
      raw.apply_decision_settlements ??
      []
    ).map((entry: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement(entry)
    ),
    metadata: raw.metadata
  };
}
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport {
  return {
    closureReports: (raw.closureReports ?? raw.closure_reports ?? []).map((entry: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport(entry)
    ),
    metadata: raw.metadata
  };
}
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowApplyResult:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult(
        raw.batch_receipt_replay_workflow_apply_result
      )
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowApplyDecision:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision(
        raw.batchReceiptReplayWorkflowApplyDecision ??
          raw.batch_receipt_replay_workflow_apply_decision
      )
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowApplyDecisionOutcome:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome(
        raw.batchReceiptReplayWorkflowApplyDecisionOutcome ??
          raw.batch_receipt_replay_workflow_apply_decision_outcome
      )
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowApplyDecisionClosureReport:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
        raw.batchReceiptReplayWorkflowApplyDecisionClosureReport ??
          raw.batch_receipt_replay_workflow_apply_decision_closure_report
      )
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowApplyRequest:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest(
        raw.batch_receipt_replay_workflow_apply_request
      )
  };
}

function normalizeStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope(
  raw: any
): StructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope {
  return {
    kind: raw.kind,
...
function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequest(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequest {
  return {
    reviewRequests: raw.review_requests.map((request: any) =>
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest(request)
    ),
    metadata: raw.metadata
  };
}

function normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequestEnvelope(
  raw: any
): StructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequestEnvelope {
  return {
    kind: raw.kind,
    ...
    batchReceiptReplayWorkflowReviewRequest:
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequest(
        raw.batch_receipt_replay_workflow_review_request
      )
  };
}
...
describe('ast-merge shared fixtures', () => {
  ...
  it('conforms to the slice-534 structured-edit provider execution invocation transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionInvocationEnvelopeFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_invocation_envelope')
    );
    const executionInvocation = normalizeStructuredEditProviderExecutionInvocation(
      fixture.structured_edit_provider_execution_invocation
    );
    const expected = normalizeStructuredEditProviderExecutionInvocationEnvelope(
      fixture.expected_envelope
    );

    expect(structuredEditProviderExecutionInvocationEnvelope(executionInvocation)).toEqual(
      expected
    );
    expect(importStructuredEditProviderExecutionInvocationEnvelope(expected)).toEqual({
      executionInvocation
    });
  });

  it('conforms to the slice-535 structured-edit provider execution invocation transport rejection fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionInvocationEnvelopeRejectionFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_invocation_envelope_rejection')
    );

    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderExecutionInvocationEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-536 structured-edit provider execution invocation envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionInvocationEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionInvocationEnvelope(
        normalizeStructuredEditProviderExecutionInvocationEnvelope(
          fixture.structured_edit_provider_execution_invocation_envelope
        )
      )
    ).toEqual({
      executionInvocation: normalizeStructuredEditProviderExecutionInvocation(
        fixture.expected_execution_invocation
      )
    });
  ...
  it('conforms to the slice-537 structured-edit provider batch execution invocation fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionInvocationFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_invocation')
    );
    ...
    for (const entry of fixture.cases) {
      expect(
        JSON.parse(
          JSON.stringify({
            batchExecutionInvocation: normalizeStructuredEditProviderBatchExecutionInvocation(
              entry.batch_execution_invocation
            )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-538 structured-edit provider batch execution invocation transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionInvocationEnvelopeFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_invocation_envelope')
    );
    const batchExecutionInvocation = normalizeStructuredEditProviderBatchExecutionInvocation(
      fixture.structured_edit_provider_batch_execution_invocation
    );
    const expected = normalizeStructuredEditProviderBatchExecutionInvocationEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderBatchExecutionInvocationEnvelope(batchExecutionInvocation)
    ).toEqual(expected);
    expect(importStructuredEditProviderBatchExecutionInvocationEnvelope(expected)).toEqual({
      batchExecutionInvocation
    });
  });

  it('conforms to the slice-539 structured-edit provider batch execution invocation transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionInvocationEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
    ...
    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderBatchExecutionInvocationEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-540 structured-edit provider batch execution invocation envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionInvocationEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionInvocationEnvelope(
        normalizeStructuredEditProviderBatchExecutionInvocationEnvelope(
          fixture.structured_edit_provider_batch_execution_invocation_envelope
        )
      )
    ).toEqual({
      batchExecutionInvocation: normalizeStructuredEditProviderBatchExecutionInvocation(
        fixture.expected_batch_execution_invocation
      )
    });
  ...
  it('conforms to the slice-541 structured-edit provider execution run result fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionRunResultFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_run_result')
    );
    ...
    for (const entry of fixture.cases) {
      expect(
        JSON.parse(
          JSON.stringify({
            executionRunResult: normalizeStructuredEditProviderExecutionRunResult(
              entry.execution_run_result
            )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-542 structured-edit provider execution run result transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionRunResultEnvelopeFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_run_result_envelope')
    );
    const executionRunResult = normalizeStructuredEditProviderExecutionRunResult(
      fixture.structured_edit_provider_execution_run_result
    );
    const expected = normalizeStructuredEditProviderExecutionRunResultEnvelope(
      fixture.expected_envelope
    );

    expect(structuredEditProviderExecutionRunResultEnvelope(executionRunResult)).toEqual(expected);
    expect(importStructuredEditProviderExecutionRunResultEnvelope(expected)).toEqual({
      executionRunResult
    });
  });

  it('conforms to the slice-543 structured-edit provider execution run result transport rejection fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionRunResultEnvelopeRejectionFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_run_result_envelope_rejection')
    );

    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderExecutionRunResultEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-544 structured-edit provider execution run result envelope application fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionRunResultEnvelopeApplicationFixture>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionRunResultEnvelope(
        normalizeStructuredEditProviderExecutionRunResultEnvelope(
          fixture.structured_edit_provider_execution_run_result_envelope
        )
      )
    ).toEqual({
      executionRunResult: normalizeStructuredEditProviderExecutionRunResult(
        fixture.expected_execution_run_result
      )
    });
  ...
  it('conforms to the slice-545 structured-edit provider batch execution run result fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionRunResultFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_run_result')
    );
    ...
    for (const entry of fixture.cases) {
      expect(
        JSON.parse(
          JSON.stringify({
            batchExecutionRunResult: normalizeStructuredEditProviderBatchExecutionRunResult(
              entry.batch_execution_run_result
            )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-546 structured-edit provider batch execution run result transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionRunResultEnvelopeFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_run_result_envelope')
    );
    const batchExecutionRunResult = normalizeStructuredEditProviderBatchExecutionRunResult(
      fixture.structured_edit_provider_batch_execution_run_result
    );
    const expected = normalizeStructuredEditProviderBatchExecutionRunResultEnvelope(
      fixture.expected_envelope
    );

    expect(structuredEditProviderBatchExecutionRunResultEnvelope(batchExecutionRunResult)).toEqual(
      expected
    );
    expect(importStructuredEditProviderBatchExecutionRunResultEnvelope(expected)).toEqual({
      batchExecutionRunResult
    });
  });

  it('conforms to the slice-547 structured-edit provider batch execution run result transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionRunResultEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-548 structured-edit provider batch execution run result envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionRunResultEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionRunResultEnvelope(
        normalizeStructuredEditProviderBatchExecutionRunResultEnvelope(
          fixture.structured_edit_provider_batch_execution_run_result_envelope
        )
      )
    ).toEqual({
      batchExecutionRunResult: normalizeStructuredEditProviderBatchExecutionRunResult(
        fixture.expected_batch_execution_run_result
      )
    });
  ...
  it('conforms to the slice-550 structured-edit provider execution receipt transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptEnvelopeFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_envelope')
    );
    const executionReceipt = normalizeStructuredEditProviderExecutionReceipt(
      fixture.structured_edit_provider_execution_receipt
    );
    const expected = normalizeStructuredEditProviderExecutionReceiptEnvelope(
      fixture.expected_envelope
    );

    expect(structuredEditProviderExecutionReceiptEnvelope(executionReceipt)).toEqual(expected);
    expect(importStructuredEditProviderExecutionReceiptEnvelope(expected)).toEqual({
      executionReceipt
    });
  });

  it('conforms to the slice-551 structured-edit provider execution receipt transport rejection fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptEnvelopeRejectionFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_envelope_rejection')
    );
  ...
  it('conforms to the slice-552 structured-edit provider execution receipt envelope application fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptEnvelopeApplicationFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_envelope_application')
    );

    expect(
      importStructuredEditProviderExecutionReceiptEnvelope(
        normalizeStructuredEditProviderExecutionReceiptEnvelope(
          fixture.structured_edit_provider_execution_receipt_envelope
        )
      )
    ).toEqual({
      executionReceipt: normalizeStructuredEditProviderExecutionReceipt(
        fixture.expected_execution_receipt
      )
    });
  ...
  it('conforms to the slice-558 structured-edit provider execution receipt replay request transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptReplayRequestEnvelopeFixture>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_request_envelope'
      )
    );
    const receiptReplayRequest = normalizeStructuredEditProviderExecutionReceiptReplayRequest(
      fixture.structured_edit_provider_execution_receipt_replay_request
    );
    const expected = normalizeStructuredEditProviderExecutionReceiptReplayRequestEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderExecutionReceiptReplayRequestEnvelope(receiptReplayRequest)
    ).toEqual(expected);
    expect(importStructuredEditProviderExecutionReceiptReplayRequestEnvelope(expected)).toEqual({
      receiptReplayRequest
    });
  });

  it('conforms to the slice-559 structured-edit provider execution receipt replay request transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplayRequestEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
    ...
    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderExecutionReceiptReplayRequestEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-560 structured-edit provider execution receipt replay request envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplayRequestEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayRequestEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayRequestEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_request_envelope
        )
      )
    ).toEqual({
      receiptReplayRequest: normalizeStructuredEditProviderExecutionReceiptReplayRequest(
        fixture.expected_receipt_replay_request
      )
    });
  ...
  it('conforms to the slice-561 structured-edit provider batch execution receipt replay request fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionReceiptReplayRequestFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_receipt_replay_request')
    );
        ...
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayRequest:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayRequest(
                entry.batch_receipt_replay_request
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-562 structured-edit provider batch execution receipt replay request transport envelope fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeFixture>(
        ...diagnosticsFixturePath(
          'structured_edit_provider_batch_execution_receipt_replay_request_envelope'
        )
      );
    const batchReceiptReplayRequest =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayRequest(
        fixture.structured_edit_provider_batch_execution_receipt_replay_request
      );
    const expected = normalizeStructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(batchReceiptReplayRequest)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(expected)
    ).toEqual({
      batchReceiptReplayRequest
    });
  });

  it('conforms to the slice-563 structured-edit provider batch execution receipt replay request transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-564 structured-edit provider batch execution receipt replay request envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayRequestEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayRequestEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_request_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayRequest: normalizeStructuredEditProviderBatchExecutionReceiptReplayRequest(
        fixture.expected_batch_receipt_replay_request
      )
    });
  ...
  it('conforms to the slice-565 structured-edit provider execution receipt replay application fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptReplayApplicationFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_replay_application')
    );
        ...
        JSON.parse(
          JSON.stringify({
            receiptReplayApplication:
              normalizeStructuredEditProviderExecutionReceiptReplayApplication(
                entry.receipt_replay_application
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-566 structured-edit provider execution receipt replay application transport envelope fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeFixture>(
        ...diagnosticsFixturePath(
          'structured_edit_provider_execution_receipt_replay_application_envelope'
        )
      );
    const receiptReplayApplication =
      normalizeStructuredEditProviderExecutionReceiptReplayApplication(
        fixture.structured_edit_provider_execution_receipt_replay_application
      );
    const expected = normalizeStructuredEditProviderExecutionReceiptReplayApplicationEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderExecutionReceiptReplayApplicationEnvelope(receiptReplayApplication)
    ).toEqual(expected);
    expect(importStructuredEditProviderExecutionReceiptReplayApplicationEnvelope(expected)).toEqual(
      {
        receiptReplayApplication
      }
    );
  ...
  it('conforms to the slice-567 structured-edit provider execution receipt replay application transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-568 structured-edit provider execution receipt replay application envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplayApplicationEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayApplicationEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayApplicationEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_application_envelope
        )
      )
    ).toEqual({
      receiptReplayApplication: normalizeStructuredEditProviderExecutionReceiptReplayApplication(
        fixture.expected_receipt_replay_application
      )
    });
  ...
  it('conforms to the slice-569 structured-edit provider batch execution receipt replay application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayApplicationFixture>(
        ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayApplication:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayApplication(
                entry.batch_receipt_replay_application
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-570 structured-edit provider batch execution receipt replay application transport envelope fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeFixture>(
        ...diagnosticsFixturePath(
          'structured_edit_provider_batch_execution_receipt_replay_application_envelope'
        )
      );
    const batchReceiptReplayApplication =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayApplication(
        fixture.structured_edit_provider_batch_execution_receipt_replay_application
      );
    const expected = normalizeStructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope(
      fixture.expected_envelope
    );
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope(expected)
    ).toEqual({
      batchReceiptReplayApplication
    });
  });

  it('conforms to the slice-571 structured-edit provider batch execution receipt replay application transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-572 structured-edit provider batch execution receipt replay application envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayApplicationEnvelope(
      ...
      batchReceiptReplayApplication:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayApplication(
          fixture.expected_batch_receipt_replay_application
        )
    });
  ...
  it('conforms to the slice-573 structured-edit provider execution receipt replay session fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptReplaySessionFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_replay_session')
    );
  ...
  it('conforms to the slice-574 structured-edit provider execution receipt replay session transport envelope fixture', () => {
    const fixture = readFixture<StructuredEditProviderExecutionReceiptReplaySessionEnvelopeFixture>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_session_envelope'
      )
    );
    const receiptReplaySession = normalizeStructuredEditProviderExecutionReceiptReplaySession(
      fixture.structured_edit_provider_execution_receipt_replay_session
    );
    const expected = normalizeStructuredEditProviderExecutionReceiptReplaySessionEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderExecutionReceiptReplaySessionEnvelope(receiptReplaySession)
    ).toEqual(expected);
    expect(importStructuredEditProviderExecutionReceiptReplaySessionEnvelope(expected)).toEqual({
      receiptReplaySession
    });
  });

  it('conforms to the slice-575 structured-edit provider execution receipt replay session transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplaySessionEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
    ...
    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderExecutionReceiptReplaySessionEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-576 structured-edit provider execution receipt replay session envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderExecutionReceiptReplaySessionEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplaySessionEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplaySessionEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_session_envelope
        )
      )
    ).toEqual({
      receiptReplaySession: normalizeStructuredEditProviderExecutionReceiptReplaySession(
        fixture.expected_receipt_replay_session
      )
    });
  ...
  it('conforms to the slice-577 structured-edit provider batch execution receipt replay session fixture', () => {
    const fixture = readFixture<StructuredEditProviderBatchExecutionReceiptReplaySessionFixture>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_receipt_replay_session')
    );
        ...
        JSON.parse(
          JSON.stringify({
            batchReceiptReplaySession:
              normalizeStructuredEditProviderBatchExecutionReceiptReplaySession(
                entry.batch_receipt_replay_session
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-578 structured-edit provider batch execution receipt replay session transport envelope fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeFixture>(
        ...diagnosticsFixturePath(
          'structured_edit_provider_batch_execution_receipt_replay_session_envelope'
        )
      );
    const batchReceiptReplaySession =
      normalizeStructuredEditProviderBatchExecutionReceiptReplaySession(
        fixture.structured_edit_provider_batch_execution_receipt_replay_session
      );
    const expected = normalizeStructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(batchReceiptReplaySession)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(expected)
    ).toEqual({
      batchReceiptReplaySession
    });
  });

  it('conforms to the slice-579 structured-edit provider batch execution receipt replay session transport rejection fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeRejectionFixture>(
        ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-580 structured-edit provider batch execution receipt replay session envelope application fixture', () => {
    const fixture =
      readFixture<StructuredEditProviderBatchExecutionReceiptReplaySessionEnvelopeApplicationFixture>(
        ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplaySessionEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_session_envelope
        )
      )
    ).toEqual({
      batchReceiptReplaySession: normalizeStructuredEditProviderBatchExecutionReceiptReplaySession(
        fixture.expected_batch_receipt_replay_session
      )
    });
  ...
  it('conforms to the slice-581 structured-edit provider execution receipt replay workflow fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath('structured_edit_provider_execution_receipt_replay_workflow')
    );
  ...
  it('conforms to the slice-582 structured-edit provider execution receipt replay workflow transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_workflow_envelope'
      )
    );
    const receiptReplayWorkflow = normalizeStructuredEditProviderExecutionReceiptReplayWorkflow(
      fixture.structured_edit_provider_execution_receipt_replay_workflow
    );
    const expected = normalizeStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowEnvelope(receiptReplayWorkflow)
    ).toEqual(expected);
    expect(importStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(expected)).toEqual({
      receiptReplayWorkflow
    });
  });

  it('conforms to the slice-583 structured-edit provider execution receipt replay workflow transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    for (const rejectionCase of fixture.cases) {
      expect(
        importStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(rejectionCase.envelope)
      ).toEqual({
        error: rejectionCase.expected_error
      });
    }
  ...
  it('conforms to the slice-584 structured-edit provider execution receipt replay workflow envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_workflow_envelope
        )
      )
    ).toEqual({
      receiptReplayWorkflow: normalizeStructuredEditProviderExecutionReceiptReplayWorkflow(
        fixture.expected_receipt_replay_workflow
      )
    });
  ...
  it('conforms to the slice-585 structured-edit provider batch execution receipt replay workflow fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath('structured_edit_provider_batch_execution_receipt_replay_workflow')
    );
        ...
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflow:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflow(
                entry.batch_receipt_replay_workflow
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-586 structured-edit provider batch execution receipt replay workflow transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_batch_execution_receipt_replay_workflow_envelope'
      )
    );
    const batchReceiptReplayWorkflow =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflow(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow
      );
    const expected = normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(
      fixture.expected_envelope
    );

    expect(
      structuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(batchReceiptReplayWorkflow)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(expected)
    ).toEqual({
      batchReceiptReplayWorkflow
    });
  });

  it('conforms to the slice-587 structured-edit provider batch execution receipt replay workflow transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-588 structured-edit provider batch execution receipt replay workflow envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowEnvelope(
      ...
      batchReceiptReplayWorkflow:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflow(
          fixture.expected_batch_receipt_replay_workflow
        )
    });
  ...
  it('conforms to the slice-590 structured-edit provider execution receipt replay workflow result transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_workflow_result_envelope'
      )
    );
    const receiptReplayWorkflowResult =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowResult(
        fixture.structured_edit_provider_execution_receipt_replay_workflow_result
      );
    const expected = normalizeStructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope(
      fixture.expected_envelope
    );
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope(expected)
    ).toEqual({
      receiptReplayWorkflowResult
    });
  });

  it('conforms to the slice-591 structured-edit provider execution receipt replay workflow result transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-592 structured-edit provider execution receipt replay workflow result envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowResultEnvelope(
      ...
      receiptReplayWorkflowResult:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowResult(
          fixture.expected_receipt_replay_workflow_result
        )
    });
  ...
  it('conforms to the slice-597 structured-edit provider execution receipt replay workflow review request fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-621 structured-edit provider execution receipt replay workflow apply result fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            receiptReplayWorkflowApplyResult:
              normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(
                entry.receipt_replay_workflow_apply_result
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-622 structured-edit provider execution receipt replay workflow apply result transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const applyResult = normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(
      fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_result
    );
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope(applyResult)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope(expected)
    ).toEqual({ receiptReplayWorkflowApplyResult: applyResult });
  });

  it('conforms to the slice-623 structured-edit provider execution receipt replay workflow apply result transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    for (const testCase of fixture.cases) {
      ...
      ).toEqual({ error: testCase.expected_error });
    }
  });

  it('conforms to the slice-624 structured-edit provider execution receipt replay workflow apply result envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const expected = normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyResult(
      fixture.expected_receipt_replay_workflow_apply_result
    );

    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyResultEnvelope(envelope)
    ).toEqual({ receiptReplayWorkflowApplyResult: expected });
  ...
  it('conforms to the slice-606 structured-edit provider execution receipt replay workflow apply request transport envelope fixture', () => {
    ...
    const applyRequest = normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyRequest(
      fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_request
    );
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyRequestEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowApplyRequestEnvelope(applyRequest)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyRequestEnvelope(expected)
    ).toEqual({
      receiptReplayWorkflowApplyRequest: applyRequest
    });
  });

  it('conforms to the slice-607 structured-edit provider execution receipt replay workflow apply request transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-608 structured-edit provider execution receipt replay workflow apply request envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      ...
      receiptReplayWorkflowApplyRequest:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyRequest(
          fixture.expected_receipt_replay_workflow_apply_request
        )
    });
  ...
  it('conforms to the slice-609 structured-edit provider batch execution receipt replay workflow apply request fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyRequest:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest(
                entry.batch_receipt_replay_workflow_apply_request
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-610 structured-edit provider batch execution receipt replay workflow apply request transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const applyRequest =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request
      );
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(applyRequest)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(expected)
    ).toEqual({
      batchReceiptReplayWorkflowApplyRequest: applyRequest
    });
  });

  it('conforms to the slice-611 structured-edit provider batch execution receipt replay workflow apply request transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-612 structured-edit provider batch execution receipt replay workflow apply request envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequestEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_request_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyRequest:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyRequest(
          fixture.expected_batch_receipt_replay_workflow_apply_request
        )
    });
  ...
  it('conforms to the slice-625 structured-edit provider batch execution receipt replay workflow apply result fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyResult:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult(
                entry.batch_receipt_replay_workflow_apply_result
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-626 structured-edit provider batch execution receipt replay workflow apply result transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const batchApplyResult =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result
      );
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(batchApplyResult)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(expected)
    ).toEqual({
      batchReceiptReplayWorkflowApplyResult: batchApplyResult
    });
  });

  it('conforms to the slice-627 structured-edit provider batch execution receipt replay workflow apply result transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-628 structured-edit provider batch execution receipt replay workflow apply result envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResultEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_result_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyResult:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyResult(
          fixture.expected_batch_receipt_replay_workflow_apply_result
        )
    });
  ...
  it('conforms to the slice-645 structured-edit provider execution receipt replay workflow apply decision settlement fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-646 structured-edit provider execution receipt replay workflow apply decision settlement transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const applyDecisionSettlement =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement(
        fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_settlement
      );
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
        applyDecisionSettlement
      )
    ).toEqual(expected);
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
      ...
      receiptReplayWorkflowApplyDecisionSettlement: applyDecisionSettlement
    });
  });

  it('conforms to the slice-647 structured-edit provider execution receipt replay workflow apply decision settlement transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-648 structured-edit provider execution receipt replay workflow apply decision settlement envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_settlement_envelope
        )
      )
    ).toEqual({
      receiptReplayWorkflowApplyDecisionSettlement:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionSettlement(
          fixture.expected_receipt_replay_workflow_apply_decision_settlement
        )
    });
  ...
  it('conforms to the slice-638 structured-edit provider execution receipt replay workflow apply decision outcome transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const applyDecisionOutcome =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome(
        fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_outcome
      );
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
        fixture.expected_envelope
      );
    ...
    expect(
      ...
      receiptReplayWorkflowApplyDecisionOutcome: applyDecisionOutcome
    });
  });

  it('conforms to the slice-639 structured-edit provider execution receipt replay workflow apply decision outcome transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-640 structured-edit provider execution receipt replay workflow apply decision outcome envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      ...
      receiptReplayWorkflowApplyDecisionOutcome:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionOutcome(
          fixture.expected_receipt_replay_workflow_apply_decision_outcome
        )
    });
  ...
  it('conforms to the slice-630 structured-edit provider execution receipt replay workflow apply decision transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(applyDecision)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(expected)
    ).toEqual({ receiptReplayWorkflowApplyDecision: applyDecision });
  });

  it('conforms to the slice-631 structured-edit provider execution receipt replay workflow apply decision transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-632 structured-edit provider execution receipt replay workflow apply decision envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_envelope
        )
      )
    ).toEqual({
      receiptReplayWorkflowApplyDecision:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecision(
          fixture.expected_receipt_replay_workflow_apply_decision
        )
    });
  ...
  it('conforms to the slice-633 structured-edit provider batch execution receipt replay workflow apply decision fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyDecision:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision(
                entry.batch_receipt_replay_workflow_apply_decision
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-634 structured-edit provider batch execution receipt replay workflow apply decision transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const batchApplyDecision =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision
      );
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
        fixture.expected_envelope
      );
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope(expected)
    ).toEqual({ batchReceiptReplayWorkflowApplyDecision: batchApplyDecision });
  });

  it('conforms to the slice-635 structured-edit provider batch execution receipt replay workflow apply decision transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-636 structured-edit provider batch execution receipt replay workflow apply decision envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyDecision:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecision(
          fixture.expected_batch_receipt_replay_workflow_apply_decision
        )
    });
  ...
  it('conforms to the slice-641 structured-edit provider batch execution receipt replay workflow apply decision outcome fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyDecisionOutcome:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome(
                entry.batch_receipt_replay_workflow_apply_decision_outcome
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-642 structured-edit provider batch execution receipt replay workflow apply decision outcome transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const batchApplyDecisionOutcome =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_outcome
      );
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
        batchApplyDecisionOutcome
      )
    ).toEqual(expected);
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
      ...
      batchReceiptReplayWorkflowApplyDecisionOutcome: batchApplyDecisionOutcome
    });
  });

  it('conforms to the slice-643 structured-edit provider batch execution receipt replay workflow apply decision outcome transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-644 structured-edit provider batch execution receipt replay workflow apply decision outcome envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcomeEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_outcome_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyDecisionOutcome:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionOutcome(
          fixture.expected_batch_receipt_replay_workflow_apply_decision_outcome
        )
    });
  ...
  it('conforms to the slice-649 structured-edit provider batch execution receipt replay workflow apply decision settlement fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyDecisionSettlement:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement(
                entry.batch_receipt_replay_workflow_apply_decision_settlement
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-650 structured-edit provider batch execution receipt replay workflow apply decision settlement transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const batchApplyDecisionSettlement =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement(
        fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement
      );
    const expected =
    ...
    expect(
      ...
      batchReceiptReplayWorkflowApplyDecisionSettlement: batchApplyDecisionSettlement
    });
  });

  it('conforms to the slice-651 structured-edit provider batch execution receipt replay workflow apply decision settlement transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement_envelope_rejection'
      )
    );
  ...
  it('conforms to the slice-652 structured-edit provider batch execution receipt replay workflow apply decision settlement envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement_envelope_application'
      )
    );
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlementEnvelope(
          fixture.structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_settlement_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyDecisionSettlement:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionSettlement(
          fixture.expected_batch_receipt_replay_workflow_apply_decision_settlement
        )
    });
  ...
  it('conforms to the slice-661 structured-edit provider execution receipt replay workflow apply decision closure report fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-662 structured-edit provider execution receipt replay workflow apply decision closure report transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const closureReport =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
        fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report
      );
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
        fixture.expected_envelope
      );
    ...
    expect(
      ...
      receiptReplayWorkflowApplyDecisionClosureReport: closureReport
    });
  });

  it('conforms to the slice-663 structured-edit provider execution receipt replay workflow apply decision closure report transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report_envelope_rejection'
      )
    );
  ...
  it('conforms to the slice-664 structured-edit provider execution receipt replay workflow apply decision closure report envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report_envelope_application'
      )
    );
    ...
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
          fixture.structured_edit_provider_execution_receipt_replay_workflow_apply_decision_closure_report_envelope
        )
      )
    ).toEqual({
      receiptReplayWorkflowApplyDecisionClosureReport:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
          fixture.expected_receipt_replay_workflow_apply_decision_closure_report
        )
    });
  ...
  it('conforms to the slice-665 structured-edit provider batch execution receipt replay workflow apply decision closure report fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowApplyDecisionClosureReport:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
                entry.batch_receipt_replay_workflow_apply_decision_closure_report
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-666 structured-edit provider batch execution receipt replay workflow apply decision closure report transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const closureReport =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
        fixture.batch_receipt_replay_workflow_apply_decision_closure_report
      );
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
        fixture.expected_envelope
      );
    ...
    expect(
      ...
      batchReceiptReplayWorkflowApplyDecisionClosureReport: closureReport
    });
  });

  it('conforms to the slice-667 structured-edit provider batch execution receipt replay workflow apply decision closure report transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_closure_report_envelope_rejection'
      )
    );
  ...
  it('conforms to the slice-668 structured-edit provider batch execution receipt replay workflow apply decision closure report envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
        'structured_edit_provider_batch_execution_receipt_replay_workflow_apply_decision_closure_report_envelope_application'
      )
    );
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReportEnvelope(
          fixture.batch_receipt_replay_workflow_apply_decision_closure_report_envelope
        )
      )
    ).toEqual({
      batchReceiptReplayWorkflowApplyDecisionClosureReport:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowApplyDecisionClosureReport(
          fixture.expected_batch_receipt_replay_workflow_apply_decision_closure_report
        )
    });
  ...
  it('conforms to the slice-598 structured-edit provider execution receipt replay workflow review request transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const expected =
      normalizeStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope(
        fixture.expected_envelope
      );

    expect(
      structuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope(reviewRequest)
    ).toEqual(expected);
    expect(
      importStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequestEnvelope(expected)
    ).toEqual({
      receiptReplayWorkflowReviewRequest: reviewRequest
    });
  });

  it('conforms to the slice-599 structured-edit provider execution receipt replay workflow review request transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-600 structured-edit provider execution receipt replay workflow review request envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      ...
      receiptReplayWorkflowReviewRequest:
        normalizeStructuredEditProviderExecutionReceiptReplayWorkflowReviewRequest(
          fixture.expected_receipt_replay_workflow_review_request
        )
    });
  ...
  it('conforms to the slice-601 structured-edit provider batch execution receipt replay workflow review request fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
      ...
      expect(
        JSON.parse(
          JSON.stringify({
            batchReceiptReplayWorkflowReviewRequest:
              normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequest(
                entry.batch_receipt_replay_workflow_review_request
              )
          })
        )
      ).toEqual({
  ...
  it('conforms to the slice-602 structured-edit provider batch execution receipt replay workflow review request transport envelope fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    const expected =
      normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequestEnvelope(
        fixture.expected_envelope
      );
    ...
    expect(
      importStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequestEnvelope(expected)
    ).toEqual({
      batchReceiptReplayWorkflowReviewRequest: batchReviewRequest
    });
  });

  it('conforms to the slice-603 structured-edit provider batch execution receipt replay workflow review request transport rejection fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
  ...
  it('conforms to the slice-604 structured-edit provider batch execution receipt replay workflow review request envelope application fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath(
    ...
    expect(
      ...
      batchReceiptReplayWorkflowReviewRequest:
        normalizeStructuredEditProviderBatchExecutionReceiptReplayWorkflowReviewRequest(
          fixture.expected_batch_receipt_replay_workflow_review_request
        )
    });
  ...
  it('conforms to the slice-681 structured-edit crispr markdown heading section replace parity fixture', () => {
    const fixture = readFixture<any>(
      ...diagnosticsFixturePath('structured_edit_crispr_markdown_heading_section_replace_parity')
    );
  ...
  it('conforms to the slice-704 Ruby gemspec dependency section policy acceptance fixture', () => {
    ...
    for (const entry of fixture.cases) {
      const finalContent = entry.report_envelope.report.final_content;
      expect(finalContent).not.toContain('add_development_dependency("json"');
      expect(finalContent).toContain('add_development_dependency("rubocop"');
    }
  });
  ...
  it('conforms to the slice-706 Ruby gemspec version-loader policy acceptance fixture', () => {
    const fixture = readFixture<{
      cases: readonly {
        label: string;
        report_envelope: any;
    ...
    for (const entry of fixture.cases) {
      const finalContent = entry.report_envelope.report.final_content;
      if (entry.label === 'modern-ruby-inline-version-loader') {
        expect(finalContent).not.toContain('gem_version =');
      }
      if (entry.label === 'legacy-ruby-gem-version-preamble') {
        expect(finalContent).toContain('spec.version = gem_version');
      }
    }
  });
  ...
  it('conforms to the slice-708 Ruby gemspec self-dependency policy acceptance fixture', () => {
    const fixture = readFixture<{
      cases: readonly {
        label: string;
        report_envelope: any;
    ...
    for (const entry of fixture.cases) {
      ...
      if (entry.label === 'delete-active-self-dependencies-preserve-comments') {
        ...
        expect(report.final_content).toContain('# spec.add_dependency "demo", "~> 0"');
  ...
  it('conforms to the slice-688 structured-edit parity match semantics fixture', () => {
    const fixture = readFixture<StructuredEditParityMatchSemanticsFixture>(
      ...diagnosticsFixturePath('structured_edit_parity_match_semantics')
    );
